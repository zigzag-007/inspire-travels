...
(function() {
    ...
    window.ToursModule = {
        ...
        tourData: [
            {
                ...
                image: "assets/img/gallery/sigiriya.jpg",
                rating: 8.0,
                duration: "3 DAYS",
            ...
            },
            {
                ...
                image: "assets/img/gallery/beach-sunset.jpg",
                rating: 8.0,
                duration: "4 DAYS",
            ...
            },
            {
                ...
                image: "assets/img/gallery/galle-fort.jpg",
                rating: 8.0,
                duration: "5 DAYS",
            ...
            },
            {
                ...
                image: "assets/img/gallery/temple-visit.jpg",
                rating: 8.0,
                duration: "7 DAYS",
            ...
            },
            {
                ...
                image: "assets/img/gallery/adams-peak.jpg",
                rating: 8.0,
                duration: "10 DAYS",
            ...
            },
            {
                ...
                image: "assets/img/gallery/whale-watching.jpg",
                rating: 8.0,
                duration: "14 DAYS",
        ...
        initTourFiltering: function() {
            this.categoryBtns = document.querySelectorAll('.category-btn');
            this.tourCardsSmall = document.querySelectorAll('.tour-card-small');
            ...
            if (this.categoryBtns) {
                this.categoryBtns.forEach(btn => {
                    btn.addEventListener('click', () => {
                        ...
                        // Filter tour cards
                        if (this.tourCardsSmall) {
                            this.tourCardsSmall.forEach(card => {
        ...
        initScrollAnimations: function() {
            ...
            window.addEventListener('scroll', this.debounce(animateOnScroll, 50));
